...
Source0  : https://files.pythonhosted.org/packages/dc/20/0b16eb0dd28c3ec6fccef77230b11e4b9ec94aa7ade1c99b1ab66d237fbe/setuptools-rust-1.5.1.tar.gz
...
%prep
%setup -q -n setuptools-rust-1.5.1
cd %{_builddir}/setuptools-rust-1.5.1
pushd ..
cp -a setuptools-rust-1.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660518115
