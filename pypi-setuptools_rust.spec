...
Source0  : https://files.pythonhosted.org/packages/ed/c6/8effd679eb1cb6d3fd9fc7837cf86c6e4c1ba7a33c3e5e35c741c04016c5/setuptools-rust-1.4.1.tar.gz
...
%prep
%setup -q -n setuptools-rust-1.4.1
cd %{_builddir}/setuptools-rust-1.4.1
pushd ..
cp -a setuptools-rust-1.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657054618
...
cp %{_builddir}/setuptools-rust-1.4.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-setuptools_rust/b6d59af9754634678ceb503c91126c4248bf14c3
