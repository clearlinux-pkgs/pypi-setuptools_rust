...
Source0  : https://files.pythonhosted.org/packages/9d/f1/2cb8887cad0726a5e429cc9c58e30767f58d22c34d55b075d2f845d4a2a5/setuptools-rust-1.9.0.tar.gz
...
%prep
%setup -q -n setuptools-rust-1.9.0
cd %{_builddir}/setuptools-rust-1.9.0
pushd ..
cp -a setuptools-rust-1.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708969371
