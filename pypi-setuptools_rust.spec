...
Source0  : https://files.pythonhosted.org/packages/e0/92/bf8589b1a2b6107cf9ec8daa9954c0b7620643fe1f37d31d75e572d995f5/setuptools_rust-1.11.1.tar.gz
...
%prep
%setup -q -n setuptools_rust-1.11.1
cd %{_builddir}/setuptools_rust-1.11.1
pushd ..
cp -a setuptools_rust-1.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743797331
