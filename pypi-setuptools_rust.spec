...
Source0  : https://files.pythonhosted.org/packages/b8/86/4f34594f21f529623b8650fe729548e3a2ad6c9ad81583391f03f74dd11a/setuptools_rust-1.10.1.tar.gz
...
%prep
%setup -q -n setuptools_rust-1.10.1
cd %{_builddir}/setuptools_rust-1.10.1
pushd ..
cp -a setuptools_rust-1.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722871662
